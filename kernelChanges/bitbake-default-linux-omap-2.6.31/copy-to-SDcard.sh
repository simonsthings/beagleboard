...
cp -v $BITBAKEDEPLOYDIR/uImage-2.6.31-r90-beagleboard.bin $DRIVE_FS/boot/uImage
cp -v $BITBAKEDEPLOYDIR/uImage-2.6.31-r90-beagleboard.bin $DRIVE_FS/boot/
cp -v $BITBAKEDEPLOYDIR/uImage-2.6.31-r90-beagleboard.bin $DRIVE_BOOT/uImage
cp -v $BITBAKEDEPLOYDIR/uImage-2.6.31-r90-beagleboard.bin $DRIVE_BOOT/

cp -v $BITBAKEDEPLOYDIR/modules-2.6.31-r90-beagleboard.tgz $DRIVE_FS/
cd $DRIVE_FS
echo "Unpacking freshly built modules..."
tar xzf modules-2.6.31-r90-beagleboard.tgz
